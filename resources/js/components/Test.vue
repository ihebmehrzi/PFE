    ...
    <div id="main-wrapper">
        <header class="header">
            <div class="header-body" >
                <div class="header-body" style="background: url('../Client/img/bgcar.jpg') top center no-repeat; background-size: cover;">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <router-link to="/createR"  class="nav-link">
                            ...
                            <li class="dropdown">
                                ...
                                <li v-if="this.state=== '1'"  @click.prevent="logout"  class="dropdown"  >

                                Déconnexion

                            </li>
                            <li  v-if="this.state=== '0'" class="login-register-link right-side-link" data-target="#test" data-toggle="modal">
                                Login
                            </li>

                            <li  v-if="this.state=== '0'" class="dropdown right-side-link "  data-target="#test1" data-toggle="modal" >
                                   Inscription
                            </li>
                            <!--- --------------------------------->
                        </ul>
        ...
        <div class="modal fade" id="test1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
             aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header text-center">
                    ...
                    <div class="modal-footer d-flex justify-content-center">
                        <button class="btn btn-indigo" @click.prevent="register" data-dismiss="modal">Send <i class="fas fa-paper-plane-o ml-1"></i></button>
                    </div>
                </div>
            </div>
        </div>
