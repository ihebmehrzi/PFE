    ...
    <div>
        ...
        <table class="table table-hover">
            ...
            <tr v-for="marqueCar in marquesCar" :key="marqueCar.id">
                ...
                <td><router-link :to="{name: 'editCarMarque', params: { id: marqueCar.id }}" class="btn btn-primary"  >Edit</router-link>
                <button class="btn btn-danger" @click.prevent="deleteModel(marqueCar.id)" >Delete</button></td>
