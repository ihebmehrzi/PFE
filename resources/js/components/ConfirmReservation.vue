<template>
  <div id="contrat">
    <div class="col-12 grid-margin">
      <h1>
        <center>CONTRAT DE LOCATION DE CAMPING-CAR</center>
      </h1>
      <div class="rq-contact-us-form-content">
        <div class="rq-car-listing-wrapper">
          <div class="rq-listing-choose rq-listing-list">
            <div class="row">
              <br>
              <br>Garage du Grand-Pont
              <br>Camping-car International
              <br>Rue du Grand-Pont 10
              <br>1350 Orbe
              <br>Tél : 024 441 12 12
              <br>Natel : 079 606 31 76 ou 079 433 20 86
              <br>
              <br>
              <br>
            </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        >&nbsp;Prise en charge du camping-car le :</label>
                        <div class="col-sm-9">
                          <p>{{reservation.date_pris_en_charge}}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        <label
                          class="col-sm-12 col-form-label"
                        >Le client s'engage à ramener le véhicule le :</label>
                        <div class="col-sm-9">
                          <p>{{reservation.date_fin_reservation}}</p>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    sendMail(email) {
      ...
      this.axios.post("api/sendMail?email=", formData).then(response => {
        console.log(response);

        Vue.swal({
          type: "success",
          title: "Email sent!",
          description: "This reservation has been confirmed."
        });
