                ...
                <div class="col-md-6">
                  <div class="mission-content">
                    ...
                    <p class="mission-text">
                      Suspendisse hendrerit facilisis ante. Sed feugiat lectus
      ...
      <div class="rq-car-listing-tab">
        <ul class="nav nav-tabs parent-tab" role="tablist">
          <li role="presentation" class="active">
            <a href="#top-popular" role="tab" data-toggle="tab">Top Popular</a>
          </li>
          <li role="presentation">
            <a href="#new-cars" role="tab" data-toggle="tab">New Cars</a>
          </li>
          <li role="presentation">
            <a href="#sale-off" role="tab" data-toggle="tab">Sale Off</a>
          </li>
        </ul>
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="car-one">
                  <div class="rq-tab-car-details">
                    ...
                    <div class="car-details-option">
                      <span>
                        <i class="ion-briefcase"></i>2 large bags
                      </span>
                      <span>
                        <i class="ion-no-smoking"></i>No smoking
                      </span>
                      <span>
                        <i class="ion-speedometer"></i>08/12 mpg
                      </span>
                      <span>
                        Starting at
                        <span class="red-section">$39.0</span>/day
                      </span>
                    </div>
                  </div>
                  <!-- /.rq-tab-car-details -->
        ...
        <div class="rq-partners-section">
          <div class="partners-wrapper">
            <div class="partner-single">
              <a href="#">
                <img src="img/partner-logo/partner1.png" alt>
              </a>
            </div>
            <div class="partner-single">
              <a href="#">
            ...
            <div class="partner-single">
              <a href="#">
                <img src="img/partner-logo/partner2.png" alt>
              </a>
            </div>
            <div class="partner-single">
              <a href="#">
                <img src="img/partner-logo/partner4.png" alt>
              </a>
            </div>
            <div class="partner-single">
              <a href="#">
                <img src="img/partner-logo/partner5.png" alt>
              </a>
            </div>
          </div>
        </div>
...
Pellentesque eueget ante venenatis euismod. Etiam in odio mattis, suscipit ex sit amet, toronil inoui bibenidum risus.
              ...
              <div class="item">
                <p class="testimoinal-text">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  <br>Pellentesque eueget ante venenatis euismod. Etiam in odio mattis, suscipit ex sit amet, toronil inoui bibenidum risus.
                </p>
                <span class="author-name-title">
                  <img src="img/testimoianl1.png" alt>
                  <a href="#">
            ...
            <div class="col-md-4">
              <div class="rq-tips-single wow fadeInLeft" data-wow-duration="500ms">
                ...
                <div class="tips-content">
                  ...
                  <h4>
                    <a href="#">Rent A Car So Easiest With A Few Minutes From Turbo</a>
                  </h4>
                  <a class="rq-btn rq-btn-normal continue-button" href="#">
                    Continue Reading
            ...
            <div class="col-md-4">
              <div class="rq-tips-single wow fadeInUp" data-wow-duration="500ms">
                ...
                <div class="tips-content">
                  ...
                  <h4>
                    <a href="#">Experience awesome travel on Mazda of Selena</a>
                  </h4>
                  <a class="rq-btn rq-btn-normal continue-button" href="#">
                    Continue Reading
                    <i class="arrow_right"></i>
            ...
            <div class="col-md-4">
              <div class="rq-tips-single wow fadeInRight" data-wow-duration="500ms">
                ...
                <div class="tips-content">
                  ...
                  <h4>
                    <a href="#">Have A Great Pinic On Moutain With Your Family In Last Week</a>
                  </h4>
                  <a class="rq-btn rq-btn-normal continue-button" href="#">
                    Continue Reading
                    <i class="arrow_right"></i>
