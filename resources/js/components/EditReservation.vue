...
<script>
    ...
    export default {
        ...
        methods: {
            updateReservation(){
                this.axios.patch(`api/reservations/${this.$route.params.id}`,this.reservation).then((response) => {
        ...
        created() {
            ...
            this.axios.get(`api/reservations/${this.$route.params.id}/edit`).then((response) => {
