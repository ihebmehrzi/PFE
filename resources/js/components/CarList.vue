        ...
        <div class="rq-content-block gray-bg small-padding-top">
            <div class="container">
                <div class="rq-listing-top-bar-filter-option">
                    ...
                    <input @keyup="getAllVoitures" type="text"  name="search" v-model="search" placeholder="Search.."   >
                                    ...
                                    <div class="listing-single"  v-for="voiture in voitures" :key="voiture.id">
                                        ...
                                        <div class="listing-details">
                                            ...
                                            <div class="listing-footer">
                                                ...
                                                <span><li>
                                                    <router-link :to="{name: 'details', params: { id: voiture.id }}" class="nav-link"> Details</router-link></li></span>
