<template>
    <div>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <router-link :to="{ name: 'createV' }" class="btn btn-primary">Create Car</router-link><br>
            </div>
        ...
        <table class="table table-hover">
            ...
            <tr v-for="voiture in voitures" :key="voiture.id">
                ...
                <td>
                    <img v-bind:src='/images/ + voiture.photo' alt="image" width="80px" height="80px" style="border-radius: 50%">
                </td>

                <td>
                    <router-link :to="{name: 'editCar', params: { id: voiture.id }}" > <i class="far fa-edit" ></i></router-link>
                    /
