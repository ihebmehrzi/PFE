...
.
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Marques:</label>
                        <select v-model="voiture.marque_id" class="form-control" @change="getModels">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <!--   <input type="file" multiple v-on:change="onFileChange" class="form-control"> -->
                        <input type="file" id="files" ref="files" multiple v-on:change="onFileChange" class="form-control"/>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" v-model="voiture.description" name="description">
        ...
        methods:{
            ...
            addVoiture(e){
              ...
              //  for(var key in e.target.files){
                   // let file = this.photo[key];
                    formData.append('photo', this.photo);
                    //formData.append('photo[' + key + ']', file); }
                    // formData.append('photo[]', e.target.files[key]);
                ...
                this.axios.post('api/cars',formData)
                    .then((response) => {
