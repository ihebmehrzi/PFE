    ...
    <div>
        ...
        <table class="table table-hover">
            ...
            <tr v-for="category in CategoyCar" :key="category.id">
                ...
                <td><router-link :to="{name: 'editCategory', params: { id: category.id }}" class="btn btn-primary">Edit</router-link>
                    <button class="btn btn-danger" @click.prevent="deleteModel(category.id)">Delete</button></td>
